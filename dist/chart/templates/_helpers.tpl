...
*/}}
{{- define "node-maintenance-controller.name" -}}
...
*/}}
{{- define "node-maintenance-controller.fullname" -}}
...
*/}}
{{- define "node-maintenance-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "node-maintenance-controller.resourceName" -}}
{{- $fullname := include "node-maintenance-controller.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "node-maintenance-controller.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "node-maintenance-controller.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
