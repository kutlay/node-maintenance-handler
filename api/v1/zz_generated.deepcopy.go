...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LinodeEntity) DeepCopyInto(out *LinodeEntity) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LinodeEntity.
func (in *LinodeEntity) DeepCopy() *LinodeEntity {
	if in == nil {
		return nil
	}
	out := new(LinodeEntity)
	in.DeepCopyInto(out)
	return out
}
